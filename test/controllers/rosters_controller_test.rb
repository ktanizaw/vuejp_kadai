...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { course: @roster.course, name: @roster.name, period: @roster.period } }
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { course: @roster.course, name: @roster.name, period: @roster.period } }
